...
namespace NeuroSdk.Actions
{
    ...
    public sealed class ActionWindow : MonoBehaviour
    {
        ...
        // Used during window creation to make Persistent Windows
        // Must be ended manually, will survive action usage
        // Defaults to false
        public ActionWindow SetPersistent()
        {
        ...
        // Adding this flag here cuz I want persistent windows for my KTANE modules.
        ...
        public void Register()
        {
            ...
            if (_contextMessage != null || _contextMessage != "")
        ...
        public ActionWindow AddAction(INeuroAction action)
        {
            ...
            if (action.ActionWindow != null)
            {
                ...
                {
                    Debug.LogError(string.Format("Cannot add action {0} to this ActionWindow because it is already included in another ActionWindow.", action.Name));
                }
            ...
            {
                    Debug.LogError(string.Format("Cannot add two actions with the same name to the same ActionWindow. Triggered by {0}", action.Name));
                return this;
            }
        ...
        public ActionWindow SetForce(Func<bool> shouldForce, string query, string state, bool ephemeralContext = false, ActionsForce.Priority priority = ActionsForce.Priority.Low){
            return SetForce(shouldForce, () => query, () => state, ephemeralContext, priority);
        }
        ...
        public ActionWindow SetForce(float afterSeconds, string query, string state, bool ephemeralContext = false, ActionsForce.Priority priority = ActionsForce.Priority.Low){
            return SetForce(afterSeconds, () => query, () => state, ephemeralContext, priority);
        }
